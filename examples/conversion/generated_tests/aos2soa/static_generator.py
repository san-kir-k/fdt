...
def construct_run_func(field_types: list[str], types_map: dict) -> str:
    ...
    run_func_str += f'    BENCHMARK("AoS -> SoA: Raw static speed: ", size * (sizeof({base_types[0]}) * {types_map[base_types[0]]}'\
...
def construct_main_func(field_types: list[str], types_map: dict) -> str:
    ...
    main_func_str += f'    alignas(8) uint8_t* aos = new unsigned char[size * ('\
